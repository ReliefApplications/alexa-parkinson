...
gulp.task('push', shell.task([
    ...
    'ssh -t tester@217.70.189.97 "cd /var/www/html/alexa-parkinson && sudo docker-compose down"',
    'ssh -t tester@217.70.189.97 "cd /var/www/html/alexa-parkinson && sudo docker-compose up -d"',
    'echo',
    'echo Push finished',
    'echo',
]));
